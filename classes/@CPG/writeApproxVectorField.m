...
% writeApproxVectorialField Generates files for the computation of 
%   approximate network vector field
%
% writeApproxVectorialField(OBJ,w_in,w_ex,w_el,M_in,M_ex,M_el)
% Generates the  filename.m file for the computation of the approximate 
% vector field
%
% writeApproxVectorialField(OBJ,w_in,w_ex,w_el,M_in,M_ex,M_el,opt )
...
if strcmp(code,'m') || strcmp(code,'matcont')
    ...
    save('Mw_cont.mat','w_in','w_ex','w_el','M_in','M_ex','M_el');
    
    if strcmp(code,'matcont')
    
    fin = fopen('matcont_bifurcation_format.m','w');
...
elseif strcmp(code,'c')||strcmp(code,'auto')
    ...
    fin = fopen([filename,'_constant.h'],'w');
    ...
    fprintf(fin,['#include "',filename,'_constant.h"\n']);
