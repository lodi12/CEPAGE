...
%
% [PRC,limitCycle] = computePRC(object,nPoints,Ttrans,varargin)
% nPoints is the number of points in which the function eval the PRC, 
% Ttrans is the transitory time used before finding a limit cycle, 
% object is the neuron_model object.
%
% To compute PRC the toolbox use the method explained in 
% Novičenko, Viktor, and Kestutis Pyragas. "Computation of phase response 
