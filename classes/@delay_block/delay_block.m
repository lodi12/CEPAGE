classdef delay_block < neuron_model
    ...
    methods
        % Constructor
        function obj = Danner_model(varargin)
            obj.nx = 1;
            obj.xnames = {'Vout'};
            obj.modelName = 'Danner model';
            if nargin == 0
            ...
            elseif nargin == 16
                ...
                obj.gl = varargin{4};
                obj. El = varargin{5};
                obj.VhalfM = varargin{6};
                obj.km = varargin{7};
                obj.Vhalfh = varargin{8};
                obj.kh = varargin{9};
                obj.tau0 = varargin{10};
                obj.tauMax = varargin{11};
                obj.VhalfTau = varargin{12};
                obj.kTau = varargin{13};
                obj.Di = varargin{14};
                obj.gSynE = varargin{15};
                obj.EsynE = varargin{16};
            else
                error('Constructor accepts 0 or 16 arguments');
            end
        end
